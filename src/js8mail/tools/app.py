        ...
        while True:
            ...
            for message in database.list_messages():
                ...
                if message.get("retry_count", 0) >= 3 and database.due_for_retry(
                    ...
                    # also retained in durable history, so the same custodian
                    # cannot be offered the message indefinitely.
                    if (
