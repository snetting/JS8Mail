...
let actionGapStyle=document.createElement('style');actionGapStyle.textContent='#messages td:nth-child(4) button{margin-right:.45em;margin-bottom:.25em}#messages td:nth-child(4) button:last-child{margin-right:0}';document.head.appendChild(actionGapStyle);
